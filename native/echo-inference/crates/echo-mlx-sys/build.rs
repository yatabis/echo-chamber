...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_function("mlx_device_(new|free)")
        .allowlist_function("mlx_stream_(get_device|get_index|new_device)")
        ...
        .allowlist_function("mlx_reset_peak_memory")
