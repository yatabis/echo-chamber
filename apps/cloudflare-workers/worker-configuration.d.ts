/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --strict-vars=false` (hash: f7179cb2fc1b7a4364b19adba3970c43)
// Runtime types generated with workerd@1.20260903.1 2025-06-10 
interface __BaseEnv_Env {
	...
	DISCORD_BOT_TOKEN_RIN: string;
	DISCORD_BOT_TOKEN_MARIE: string;
	OPENAI_API_KEY: string;
	LOG_CHANNEL_ID: string;
	RIN_MAIN_LLM_MODEL: string;
	MARIE_MAIN_LLM_PROVIDER: string;
	MARIE_MAIN_LLM_MODEL: string;
	MARIE_MAIN_LLM_BASE_URL: string;
	MARIE_MAIN_LLM_API_KEY: string;
	ECHO: DurableObjectNamespace<import("./src/index").Echo>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Echo";
	}
